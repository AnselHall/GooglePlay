package com.exe.googleplay.manager;
...
import com.exe.googleplay.http.HttpHelper.HttpResult;
...
public class DownloadManager {
    //定义下载目录     /mnt/sdcard/com.exe.googleplay/download
    ...
    class DownloadTask implements Runnable {
        ...
        public void run() {
            ...
            String commonUrl = Url.HOST + "/" + downloadInfo.getDownloadUrl();
...
//            }
            ...
            httpResult = HttpHelper.download(commonUrl);
